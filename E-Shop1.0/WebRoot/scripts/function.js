...
// onscroll事件，使在线聊天框随滚动条滚动
window.onscroll=function(){
	var divChater=document.getElementById("chater");
	divChater.style.position="absolute";
	//alert(chater.style.pixelTop+"|"+chater.style.pixelLeft);
	//alert(document.body.scrollTop+":"+document.body.scrollLeft);
	divChater.style.pixelTop=document.documentElement.scrollTop - 200 +"px";
	divChater.style.pixelLeft=document.documentElement.scrollLeft + 1000 + "px";
};
...
function scrollChater()
{
	...
	chater.style.pixelLeft = scrollLeft + document.documentElement.clientWidth - 92 + "px";
	chater.style.pixelTop = scrollTop + document.documentElement.clientHeight - 25 + "px";
}
